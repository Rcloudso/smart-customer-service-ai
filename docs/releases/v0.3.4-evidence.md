...
> Status: released. PR #16 passed its test and pinned-Qdrant checks, merged to
> `main` as `d8f21a3`, and merged-main CI run `30796209416` passed. Annotated
> tag `v0.3.4` and the non-draft, non-prerelease GitHub Release were published
> on 2026-08-03.
